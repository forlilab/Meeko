...
class MoleculeSetup(object):
    ...
    def __init__(self, obmol, template=None, amide_flexible=False, is_protein_sidechain=False):
        ...
        if template is None:
            self.init_from_obmol(obmol, amide_flexible, is_protein_sidechain)
    ...
    def init_from_obmol(self, obmol, amide_flexible=False, is_protein_sidechain=False):
